...
public:
  ...
  // Method to generate a random number with an exponential distribution in range [0, +inf)
  double Exponential(double lambda);
  // Method to generate a random number with a Cauchy-Lorentz distribution in range (-inf, +inf)
  double CauchyLorentz(double x0, double gamma);
